...
const Landing = ({ showVideo, setAlert }) => {
  ...
  const [jumbo, setJumbo] = useState("img");
            ...
            >
              ...
              {choice === "big-cards" && (
                <Fragment>
                  ...
                  {bigCard === "imgnobg-text-big-rev" && (
                    <BCardIMGnoBgTextBigRev />
                  )}
              ...
              {/** File Showcase */}
              {choice === "files" && (
                <Fragment>{file === "upload" && <UploadComp />}</Fragment>
              )}
              ...
              {/**Security Showcase */}
              {choice === "security" && (
                <Fragment>{security === "captcha" && <CaptchaComp />}</Fragment>
              )}
              ...
              {choice === "tables" && (
                <Fragment>
                  {table === "simple" && (
                    <Table data="products" list={Products} />
                  )}
                  {table === "table-buttons" && (
