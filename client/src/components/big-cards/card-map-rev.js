...
const BCardMapRev = () => {
  return (
    <Fragment>
      <div className="cards">
        <div class="card-md-text-map-rev">
          <h1 class="sm-h1 show-sm">Card Text + Map</h1>
          <div class="line-sm show-sm"></div>
          <div class="left">
            <Iframe
          ...
          <div class="right">
            <h1 class="sm-h1 hide-sm">Card Text + Map</h1>
            <div class="line-sm hide-sm"></div>
            <div class="card">
              <div class="top">
                <p>
